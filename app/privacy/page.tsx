      ...
      <main className="mx-auto max-w-3xl px-5 pb-24 pt-32 md:px-8 md:pt-40">
        ...
        <div className="mt-12 space-y-8 leading-relaxed [&_h2]:text-xl [&_h2]:font-medium [&_h2]:mt-10 [&_h2]:mb-3 [&_p]:opacity-80 [&_li]:opacity-80 [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:space-y-1">
          ...
          <div>
            ...
            <ul>
              <li><strong>Information you provide</strong> — name, email, organization, and any message you send through our contact or sales enquiries.</li>
          ...
          <div>
            ...
            <p>
              ...
              <a className="underline" href={`mailto:${email}`}>{email}</a>. We operate across {jurisdiction}.
            </p>
          </div>
        </div>
      </main>
